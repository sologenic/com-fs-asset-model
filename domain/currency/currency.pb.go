...
const file_domain_currency_currency_proto_rawDesc = "" +
	"\n" +
	"\x1edomain/currency/currency.proto\x12\bcurrency\x1a\x1bbuf/validate/validate.proto\"y\n" +
	"\bCurrency\x126\n" +
	"\x06Symbol\x18\x01 \x01(\tB\x1e\xbaH\x1b\xc8\x01\x01r\x162\x14^[a-zA-Z0-9.]{1,45}$R\x06Symbol\x125\n" +
