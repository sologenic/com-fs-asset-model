...
type Asset struct {
	...
	IsIssued      bool `protobuf:"varint,17,opt,name=IsIssued,proto3" json:"IsIssued,omitempty"`
...
const file_asset_proto_rawDesc = "" +
	...
	"\tUpdatedAt\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampB\x06\xbaH\x03\xc8\x01\x01R\tUpdatedAt\x12\x1a\n" +
	"\bIsIssued\x18\x11 \x01(\bR\bIsIssuedB\v\n" +
	"\t_IssuedAt\"X\n" +
	"\x06Assets\x12&\n" +
...
var file_asset_proto_depIdxs = []int32{
	...
	6, // 5: asset.Asset.CreatedAt:type_name -> google.protobuf.Timestamp
	6, // 6: asset.Asset.UpdatedAt:type_name -> google.protobuf.Timestamp
	2, // 7: asset.Assets.Records:type_name -> asset.Asset
	0, // 8: asset.File.Type:type_name -> asset.FileType
